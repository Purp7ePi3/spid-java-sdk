...
/**
 * Autoconfiguration Spring Boot per SPID.
 * Registra automaticamente tutti i bean necessari
 * quando spid-spring è nel classpath.
 *
 * Basta aggiungere la dipendenza e configurare application.yml.
 */
@AutoConfiguration
